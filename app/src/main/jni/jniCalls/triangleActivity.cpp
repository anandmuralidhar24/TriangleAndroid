...
Java_com_anandmuralidhar_triangleandroid_TriangleActivity_CreateObjectNative(JNIEnv *env,
                                                                             jobject instance,
...
JNIEXPORT void JNICALL
Java_com_anandmuralidhar_triangleandroid_TriangleActivity_DeleteObjectNative(JNIEnv *env,
                                                                             jobject instance) {
